...
### 4.1 Importación y validación CSV
...
- Incluye una plantilla descargable con datos ficticios.
...
2. **Entrada:** archivo CSV seleccionado por el usuario.
3. **Validación:** normalización de encabezados, números y filas.
4. **Motor analítico:** funciones TypeScript puras y deterministas.
5. **Módulo de conteos:** planificación, captura física y conciliación por campaña.
6. **Presentación:** dashboard, tablas, filtros, explicación y simulador.
7. **Salida:** CSV generado en el navegador.
